...
<link rel="stylesheet" href="<?=base_url('assets/css/cards/theme-six.css')?>">
    ...
    <div class="container">
        ...
        if($reorder_section == 'main_card_section'){ ?>
            ...
            <div class="row mt-1">
                ...
                <div class="col-md-6 mx-auto shadow rounded p-0">
                    <div class="card card-profile mb-0">
                        ...
                        <div class="picture">
                            <img class="img-fluid" src="<?=isset($meta_image)?htmlspecialchars($meta_image):''?>" class="img-radius" alt="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>">
                        </div>
                        <div class="team-content">
                            <h3 class="name"><?=isset($card['title'])?htmlspecialchars($card['title']):''?></h3>
                            <h4 class="title"><?=isset($card['sub_title'])?htmlspecialchars($card['sub_title']):''?></h4>
                            <h5><?=isset($card['description'])?htmlspecialchars($card['description']):''?></h5>
                        </div>
