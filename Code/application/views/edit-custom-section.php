        ...
        <div class="main-content">
          <section class="section">
            <div class="section-header">
              ...
              <h1><?=$this->lang->line('edit_custom_section')?htmlspecialchars($this->lang->line('edit_custom_section')):'Edit Custom Section'?></h1>
              <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><?=$this->lang->line('edit_custom_section')?htmlspecialchars($this->lang->line('edit_custom_section')):'Edit Custom Section'?></div>
              </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-primary" id="custom_section-card">
                        <form action="<?=base_url('cards/edit_custom_sections')?>" method="POST" id="custom_section-form">
                          <input type="hidden" name="update_id" id="update_id" value="<?=htmlspecialchars($custom_section[0]['id'])?>">
                          ...
                          <div class="card-body row">
                            ...
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" name="title" value="<?=htmlspecialchars($custom_section[0]['title'])?>" class="form-control" required>
                            </div>

                            <div class="form-group col-md-12">
                              <label><?=$this->lang->line('content')?htmlspecialchars($this->lang->line('content')):'Content'?><span class="text-danger">*</span></label>
                              <textarea type="text" name="content" class="form-control"><?=htmlspecialchars($custom_section[0]['content'])?></textarea>
                            </div>
