...
<html lang="en">
	...
	<body>
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-right text-uppercase">
						...
						<?php if(frontend_permissions('home') && $home){  
							$my_lang = $this->session->userdata('lang')?$this->session->userdata('lang'):default_language();
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-10 wow fadeIn" data-wow-delay="0.3s">
							...
							<a href="#demo" class="btn btn-primary  mt-25">Try Demo</a>
							<a href="<?=base_url('auth/register')?>" class="btn btn-primary  mt-25">Create My vCard</a>
						</div>
						<div class="col-md-1"></div>
					</div>
				</div>
		...
		<section id="demo" <?=($home->{$my_lang}->title || $home->{$my_lang}->description)?'':'class="mt-25"'?>>
			<div class="container <?=($home->{$my_lang}->title || $home->{$my_lang}->description)?'':'mt-25'?>">
				<div class="row">
          			<div class="col-md-12 wow bounceIn features">
						<h2 class="text-uppercase"><?=$this->lang->line('demo_card_themes')?htmlspecialchars($this->lang->line('demo_card_themes')):'Demo vCard Themes'?></h2>
          			</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 wow fadeInRight" data-wow-delay="0.6s">
						<img src="<?=base_url('assets/frontend/application.png')?>" class="img-responsive" alt="How it works?">
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 wow fadeInUp templatemo-box" data-wow-delay="0.3s">
						...
						<i class="front-feature-icon <?=htmlspecialchars($feature['icon'])?>"></i>
						<?php } ?>
