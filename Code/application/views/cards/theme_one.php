...
<link rel="stylesheet" href="<?=base_url('assets/css/cards/theme-one.css')?>">
<style>
	...
	<div class="container">
        ...
        <?php if(isset($card['reorder_sections']) && !empty($card['reorder_sections'])){  
            ...
            if($reorder_section == 'main_card_section'){ ?>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-5 m-0 mt-1 p-0">
                        <div class="card user-card shadow rounded m-0">
                            <div class="card-block">
                                ...
                                <div class="user-image">
                                    <img src="<?=isset($meta_image)?htmlspecialchars($meta_image):''?>" class="img-radius" alt="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>">
                                </div>
                                <h5><?=isset($card['title'])?htmlspecialchars($card['title']):''?></h5>
                                <h6 class="font-weight-normal"><?=isset($card['sub_title'])?htmlspecialchars($card['sub_title']):''?></h6>
                                <hr>
                                <h6 class="font-weight-normal"><?=isset($card['description'])?htmlspecialchars($card['description']):''?></h6>
                                <hr>
                                <ul class="contact-details">
                                    ...
                                    if(($card['id'] == 1 && isset($custom_fields) && $custom_fields != '') || (isset($custom_fields) && $custom_fields != '')){ foreach($custom_fields as $key => $custom_field){
                                        ...
                                        <h6 class="mt-0 mb-0 text-left"><?=(isset($text) && $text != '')?htmlspecialchars($text):((isset($edite_url) && $edite_url != '')?htmlspecialchars($edite_url):'')?></h6></a>
                                        </li>
                                    <?php } } ?>
            ...
            <?php }elseif($reorder_section == 'products_services'){ ?>
                ...
                <?php if(($card['id'] == 1 || ($card_plan_modules && $card_plan_modules['products_services'])) && isset($products) && $products != ''){ ?>
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5 m-0 mt-1 p-0">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="card-left">
                                                            ...
                                                            <div class="headline-text">
                                                                <h3>ONE GOD, ONE WORLD, ONE PEOPLE </h3>
                                                                <h1>ONE WORLD PEACE MAKER FOUNDATION</h1>
                                                                <h3>FUTURE IS TODAY, RESOLVING TODAYS NEED IS, TOMORROWS FUTURE</h3>
                                                            </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-right">
                                                            ...
                                                            <p>
                                                                243/36/11, Ma Lo Street, Quater 10, Binh Tri Dong A Ward, Binh Tan District. mariena@oneworldpeacemaker.foundation
                                                            </p>
                                                            </div>
                                                            <div class="overlay">
                                                            <div class="mid-grid">
                                                                ...
                                                                <div id="item-2">
                                                                <!-- 
                                                                    If U want use one photo doesnt need manual
                                                                    <img 
                                                                        src="https://i.ibb.co/2KBQ8jy/Screenshot-2023-08-14-131229-removebg-preview.png" 
                                                                        alt="logo"
                                                                        class="image-logo"
                                                                    /> 
                                                                -->
            ...
            <?php }elseif($reorder_section == 'portfolio'){ ?>
                ...
                <?php if(($card['id'] == 1 || ($card_plan_modules && $card_plan_modules['portfolio'])) && isset($portfolio) && $portfolio != ''){ ?>
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5 m-0 mt-1 p-0">
                            <div class="card p-2 m-0">
                                <div class="card-header d-flex justify-content-center p-0">
            ...
            <?php }elseif($reorder_section == 'gallery'){ ?>
                ...
                <?php if(($card['id'] == 1 || ($card_plan_modules && $card_plan_modules['gallery'])) && isset($gallery) && $gallery != ''){ ?>
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5 m-0 mt-1 p-0">
                            <div class="card p-2 m-0">
                                <div class="card-header d-flex justify-content-center p-0">
            ...
            <?php }elseif($reorder_section == 'testimonials'){ ?>
                ...
                <?php if(($card['id'] == 1 || ($card_plan_modules && $card_plan_modules['testimonials'])) && isset($testimonials) && $testimonials != ''){ ?>
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-5 m-0 mt-1 p-0">
                            <div class="card p-2 m-0">
                                <div class="card-header d-flex justify-content-center p-0">
                                    ...
                                    <div class="owl-carousel owl-theme products-carousel">
                                        ...
                                        <div>
                                            <div class="product-item pb-3">
                                                ...
                                                <div class="text-small"><?=htmlspecialchars($product['description'])?></div>
                                                </div>  
                                            </div>
                                        </div>
                                        <?php } ?>
            ...
            <?php }elseif($reorder_section == 'qr_code'){ ?>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-5 m-0 mt-1 p-0">
                        <div class="card text-center p-2 m-0">
                            <div class="card-header d-flex justify-content-center p-0">
            ...
            <?php }elseif($reorder_section == 'custom_sections'){ ?>
                ...
                <?php 
                    if(isset($ad_code) && !empty($ad_code) && in_array('custom_sections', $ad_area)){ 
