...
<link rel="stylesheet" href="<?=base_url('assets/css/cards/theme-eight.css')?>">
</head>
<body>
    ...
    <div class="container">
        ...
        if($reorder_section == 'main_card_section'){ ?>
            ...
            <div class="row mt-1">
                <div class="card col-md-5 mx-auto mb-0">
                    ...
                    <div class="cover-photo" <?=(isset($banner) && $banner != '')?'style="background-image:url('.htmlspecialchars($banner).')"':''?>>
                        <img src="<?=isset($meta_image)?htmlspecialchars($meta_image):''?>" class="profile">
                    </div>
                    <div class="profile-name"><?=isset($card['title'])?htmlspecialchars($card['title']):''?></div>
                    <div class="profile-subtile"><?=isset($card['sub_title'])?htmlspecialchars($card['sub_title']):''?></div>
                    <p class="about"><?=isset($card['description'])?htmlspecialchars($card['description']):''?></p>
                    ...
                    <hr>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <a id="download-file" download="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>.vcf" href="#" class="btn btn-sm btn-icon icon-left btn-outline-dark col-md-5 mb-3 mt-1 mr-1 ml-1"><i class="fas fa-download"></i> <?=$this->lang->line('add_to_phone_book')?htmlspecialchars($this->lang->line('add_to_phone_book')):'Add to Phone Book'?></a>
                                    <?php } ?>
                                    <?php if($card['show_share'] == 1){ ?>
                                    <a data-toggle="modal" data-target="#socialShare" href="#" class="btn btn-sm btn-icon icon-left btn-outline-dark col-md-5 mb-3 mt-1 mr-1 ml-1"><i class="fas fa-share-alt"></i> <?=$this->lang->line('share')?htmlspecialchars($this->lang->line('share')):'Share'?></a>
                                    <?php } ?>
                                </div>
                </div>
            </div>
