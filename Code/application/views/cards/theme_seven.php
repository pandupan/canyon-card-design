...
<link rel="stylesheet" href="<?=base_url('assets/css/cards/theme-seven.css')?>">
...
<body>
    ...
    <div class="container">
        ...
        if($reorder_section == 'main_card_section'){ ?>
            ...
            <div class="row mt-1">
                <div class="col-md-5 mx-auto shadow rounded p-0">
                    ...
                    <div class="card text-white mb-0">
                        ...
                        <div class="img-container d-flex align-items-start justify-content-start mt-4"><img src="<?=isset($meta_image)?htmlspecialchars($meta_image):''?>" class="rounded-circle" alt="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>"></div>
                        <div class="user"">
                            <div class="h2 text-center mt-2 mb-2"><?=isset($card['title'])?htmlspecialchars($card['title']):''?></div>
                            <div class="text-center text-white"><span class="followers"><?=isset($card['sub_title'])?htmlspecialchars($card['sub_title']):''?></span></div>
                        ...
                        <div class="row justify-content-center mb-2">
                            ...
                            <a id="download-file" download="<?=isset($card['title'])?htmlspecialchars($card['title']):''?>.vcf" href="#" class="btn btn-sm btn-icon icon-left btn-outline-dark col-md-5 mt-1 mr-1 ml-1 mb-1"><i class="fas fa-download"></i> <?=$this->lang->line('add_to_phone_book')?htmlspecialchars($this->lang->line('add_to_phone_book')):'Add to Phone Book'?></a>
                            <?php } ?>
                            <?php if($card['show_share'] == 1){ ?>
                            <a data-toggle="modal" data-target="#socialShare" href="#" class="btn btn-sm btn-icon icon-left btn-outline-dark col-md-5 mt-1 mr-1 ml-1 mb-1"><i class="fas fa-share-alt"></i> <?=$this->lang->line('share')?htmlspecialchars($this->lang->line('share')):'Share'?></a>
                            <?php } ?>
                        </div>
