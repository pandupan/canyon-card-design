<form action="<?=base_url('settings/save-custom-code-setting')?>" method="POST" id="language-form">
    <div class="card-body row">
      <div class="form-group col-md-12">
          ...
          <textarea name="header_code" id="header_code"><?=htmlspecialchars($header_code)?></textarea>
      </div>
      <div class="form-group col-md-12">
        <label><?=$this->lang->line('footer_code')?$this->lang->line('footer_code'):'Footer Code'?></label>
        <textarea name="footer_code" id="footer_code"><?=htmlspecialchars($footer_code)?></textarea>
      </div>
    </div>
